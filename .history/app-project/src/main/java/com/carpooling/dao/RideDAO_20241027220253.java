...
public class RideDAO {
    ...
    public static boolean createRide(Ride ride) {
        String query = "INSERT INTO rides (driver_id, origin, destination, date_time, available_seats, price, status, created_at, updated_at, comments) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            pstmt.setString(10, ride.getComments());
